...
!LastPoseIndex = !NormalLastPoseIndex
!AnimationIndex = !NormalAnimationIndex
!AnimationPoseIndex = !NormalAnimationPoseIndex
!AnimationTimer = !NormalAnimationTimer
...
!HitboxTableB = !NormalHitboxTableB
!HitboxTableH = !NormalHitboxTableH
!HitboxTableL = !NormalHitboxTableL

!PlayerIsAbove = !HitmanNormalPlayerIsAbove

!RenderBox = %DXNormalRenderBox()
!PaletteAssignment = %DXNormalPaletteAssignment()
!PaletteAssignmentNoUpload = %DXNormalPaletteAssignmentNoUpload()
!Upload = %DXNormalUpload()
!UploadWithoutPoseOffset = %DXNormalUploadWithoutPoseOffset()
!DXDraw = %DXNormalDraw()
!DXDrawWithOffset = %DXNormalDrawWithOffset()
!ConcatenateRGBPaletteEffectToGlobal = %DXNormalConcatenateRGBPaletteEffectToGlobal()
!ReplacePalette = %DXNormalReplacePalette()
