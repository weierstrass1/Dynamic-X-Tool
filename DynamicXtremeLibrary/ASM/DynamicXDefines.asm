...
!LoadPaletteGlobalEffect = read3(!Routines+$36)
...
!MixAndMergeRGB = read3(!Routines+$48)
!MixAndMergeHSL = read3(!Routines+$4B)
!MixAndMergeRG = read3(!Routines+$4E)
!MixAndMergeHS = read3(!Routines+$51)
!MixAndMergeRB = read3(!Routines+$54)
!MixAndMergeHL = read3(!Routines+$57)
!MixAndMergeGB = read3(!Routines+$5A)
!MixAndMergeSL = read3(!Routines+$5D)
!MixAndMergeR = read3(!Routines+$60)
!MixAndMergeH = read3(!Routines+$63)
!MixAndMergeG = read3(!Routines+$66)
!MixAndMergeS = read3(!Routines+$69)
!MixAndMergeB = read3(!Routines+$6C)
!MixAndMergeL = read3(!Routines+$6F)
!PalTransitionAndMergeRGB = read3(!Routines+$72)
!PalTransitionAndMergeHSL = read3(!Routines+$75)
!PalFunctionAndMergeRGB = read3(!Routines+$78)
!PalFunctionAndMergeHSL = read3(!Routines+$7B)
!MixHSL = read3(!Routines+$7E)
!MixRG = read3(!Routines+$81)
!MixHS = read3(!Routines+$84)
!MixRB = read3(!Routines+$87)
!MixHL = read3(!Routines+$8A)
!MixGB = read3(!Routines+$8D)
!MixSL = read3(!Routines+$90)
!MixR = read3(!Routines+$93)
!MixH = read3(!Routines+$96)
!MixG = read3(!Routines+$99)
!MixS = read3(!Routines+$9C)
!MixB = read3(!Routines+$9F)
!MixL = read3(!Routines+$A2)
!PalTransitionRGB = read3(!Routines+$A5)
!PalTransitionHSL = read3(!Routines+$A8)
!PalFunctionRGB = read3(!Routines+$AB)
!PalFunctionHSL = read3(!Routines+$AE)
!RGBToHSL = read3(!Routines+$B1)
!HSLToRGB = read3(!Routines+$B4)
!DoEffectAndMerge = read3(!Routines+$B7)
!DoEffect = read3(!Routines+$BA)
!RGBMerge = read3(!Routines+$BD)
!AllowedGameMode = read3(!Routines+$C0)
!GameModeTable = !Routines+$C3
if !Desinstallation == 0
