...
if !PaletteEffects
    LDA !ExtendedPaletteAssignment,x
    AND #$20
    BNE ?+

    LDA !ExtendedPaletteOption,x
    AND #$80
    BEQ ?+
...
?.DoEffects
    ...
    LDA #$0F
    STA $05
    LDA !ExtendedBasePaletteLoaded,x
    AND #$04
    BNE +
    LDA #$04
    ORA !ExtendedBasePaletteLoaded,x
    STA !ExtendedBasePaletteLoaded,x
...
+
    ...
    PHA
    LDX !SpriteIndex
    AND !ExtendedBasePaletteLoaded,x
    BEQ ?+
